 ...
 * what is missing. Set MISSION_START / MISSION_END in the environment to
...
// The actual run: 19-27 October 2026, nine days, Europe/Berlin.
const START = process.env.MISSION_START || '2026-10-19';
const END = process.env.MISSION_END || '2026-10-27';
...
).run(process.env.MISSION_NAME || 'MARS — HABITAT ONE', START, END,
      process.env.MISSION_TZ || 'Europe/Berlin');
